    ...
    >
      {!isSuccess ? (
        <form onSubmit={handleSubmit}>
          <div className="mb-6">
            <p className="text-gray-600 mb-4">
              Available Balance: <span className="font-semibold">${currentBalance.toLocaleString()}</span>
            </p>
        ...
        <div className="text-center py-6">
          ...
          <h3 className="text-xl font-semibold text-gray-800 mb-2">Withdrawal Request Submitted</h3>
